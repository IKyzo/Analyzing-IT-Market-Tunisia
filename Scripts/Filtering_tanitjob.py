...
input_file = './Tanitjob_data_all_pages_20240612_164240.xlsx'  # Replace with your actual file path
...
output_file = f'filtered_it_jobs_tanitjob_{current_datetime}.xlsx'  # Output file name includes current date and time
